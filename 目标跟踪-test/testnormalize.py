...
for center in points_int:
    ...
    cv2.arrowedLine(img, (center[0], center[1]), (center[0] + V_change[0, 0],
                                                  center[1] + V_change[0, 1]), (0, 255, 255), 1)
    cv2.arrowedLine(img, (center[0], center[1]), (center[0] + V_change[1, 0],
                                                  center[1] + V_change[1, 1]), (255, 0, 0), 1)
